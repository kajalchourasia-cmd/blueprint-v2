...
.landing-intro{padding:31px 0 30px;color:var(--ink);border-bottom:1px solid rgba(24,26,25,.16)}
...
.bp-section{max-width:1200px;margin:0 auto;padding:90px 0;color:var(--ink)}.bp-rule{border-top:1px solid #b9bcb9;padding-top:13px;color:#747975;font:10px 'DM Mono',monospace;letter-spacing:.09em;text-transform:uppercase}.bp-section h2{max-width:820px;margin:18px 0 38px;font:500 clamp(38px,5.4vw,72px)/.94 'Space Grotesk',sans-serif;letter-spacing:-.07em}.bp-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:13px}.bp-card{min-height:205px;padding:22px;border:1px solid #c6c9c5;border-radius:25px;background:rgba(255,255,255,.58);display:flex;flex-direction:column;justify-content:space-between;transition:.25s}.bp-card:hover{transform:translateY(-4px);background:#fff;box-shadow:0 18px 40px rgba(27,32,28,.08)}.bp-card strong{font:500 22px 'Space Grotesk',sans-serif;letter-spacing:-.045em}.bp-card span{max-width:270px;color:#6f746f;font:14px/1.45 'Space Grotesk',sans-serif}.bp-start{padding:40px;border-radius:30px;background:#202321;color:#f5f6f3;display:flex;align-items:end;justify-content:space-between;gap:25px}.bp-start h2{font-size:52px}.bp-try{display:inline-block;padding:13px 17px;border-radius:17px;background:#fff;color:#202321;text-decoration:none;font:500 10px 'DM Mono',monospace;white-space:nowrap}
.bp-section.tint{position:relative;max-width:1280px;margin-top:34px;padding:72px 54px;border:1px solid rgba(31,91,58,.18);border-radius:38px;background:linear-gradient(135deg,rgba(224,239,228,.92),rgba(247,249,244,.68));overflow:hidden}.bp-section.tint.method{background:linear-gradient(135deg,rgba(24,70,46,.97),rgba(39,95,62,.93));color:#f2f7f3}.bp-section.tint.method .bp-rule{border-color:rgba(255,255,255,.28);color:#b9d5c2}.bp-section.tint.method .bp-card{border-color:rgba(255,255,255,.18);background:rgba(255,255,255,.1)}.bp-section.tint.method .bp-card:hover{background:rgba(255,255,255,.16);box-shadow:0 22px 48px rgba(7,28,16,.2)}.bp-section.tint.method .bp-card span{color:#c8dbce}.bp-section.tint:after{content:'';position:absolute;right:-80px;top:-110px;width:330px;height:330px;border-radius:50%;border:1px solid rgba(43,124,76,.22);box-shadow:inset 0 0 0 42px rgba(53,130,83,.06),inset 0 0 0 84px rgba(53,130,83,.04);pointer-events:none}.bp-section.tint.method:after{border-color:rgba(255,255,255,.18);box-shadow:inset 0 0 0 42px rgba(255,255,255,.04),inset 0 0 0 84px rgba(255,255,255,.03)}.bp-section.tint>*{position:relative;z-index:1}.bp-card-index{display:grid;place-items:center;width:38px;height:38px;border-radius:50%;background:#235f3d;color:#eff7f1;font:10px 'DM Mono';margin-bottom:32px}.method .bp-card-index{background:#d9efae;color:#183b29}.bp-start{background:linear-gradient(130deg,#172d21,#245f3d);box-shadow:0 24px 60px rgba(25,68,43,.16)}.bp-try{transition:.22s}.bp-try:hover{background:#d9efae;transform:translateY(-2px)}
...
@media(max-width:800px){main .block-container{padding:0 18px 70px}.landing-intro h1{margin-top:25px}.bp-cards{grid-template-columns:1fr}.bp-section{padding:64px 0}.bp-section.tint{padding:52px 22px;border-radius:28px}.bp-start{display:block;padding:27px}.bp-start h2{font-size:40px}.bp-try{margin-top:20px}.st-key-hero_idea_entry{height:auto;min-height:320px}}
</style>
""",
...
st.markdown(
    """
<section class="bp-section tint"><div class="bp-rule">02 / The promise</div><h2>Do not build the whole thing. Find the next proof.</h2><div class="bp-cards"><div class="bp-card"><div class="bp-card-index">01</div><strong>Reality before momentum</strong><span>See the assumptions your idea is quietly asking you to make.</span></div><div class="bp-card"><div class="bp-card-index">02</div><strong>Evidence-producing work</strong><span>Turn the next unknown into something you can test outside the screen.</span></div><div class="bp-card"><div class="bp-card-index">03</div><strong>The cost of continuing</strong><span>Know what the next commitment takes from your money, time, and life.</span></div></div></section>
<section class="bp-section tint method"><div class="bp-rule">03 / The method</div><h2>Every next step should earn the one after it.</h2><div class="bp-cards"><div class="bp-card"><div class="bp-card-index">01</div><strong>Name the bet</strong><span>State what must be true before you invest more.</span></div><div class="bp-card"><div class="bp-card-index">02</div><strong>Test in the world</strong><span>Capture behavior, commitments, and contradictions.</span></div><div class="bp-card"><div class="bp-card-index">03</div><strong>Decide honestly</strong><span>Continue, change direction, or stop with the evidence in front of you.</span></div></div></section>
<section class="bp-section" id="start"><div class="bp-start"><div><div class="bp-rule" style="border-color:#557765;color:#bad0c0">04 / Begin</div><h2 style="margin-bottom:17px">Bring the unfinished version.</h2><p style="max-width:590px;margin:0;color:#c6d5ca;font:15px/1.5 'Space Grotesk',sans-serif">You do not need a pitch deck or polished answers. The field above is enough to begin.</p></div><a class="bp-try" href="#idea-field">GO TO THE IDEA FIELD ↑</a></div></section>
""",
    unsafe_allow_html=True,
)
