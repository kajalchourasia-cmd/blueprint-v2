...
.st-key-hero_idea_entry{box-sizing:border-box;height:328px;min-height:328px;padding:23px 24px 20px;border:1px solid #d2d5d1;border-radius:30px;background:rgba(255,255,255,.86);box-shadow:0 24px 60px rgba(33,38,34,.11),inset 0 1px 0 #fff;display:flex;flex-direction:column;justify-content:space-between;position:relative;overflow:hidden}.st-key-hero_idea_entry:before{content:'';position:absolute;right:-55px;top:-70px;width:220px;height:220px;border-radius:50%;background:radial-gradient(circle,rgba(69,139,92,.13),transparent 68%);pointer-events:none}.st-key-hero_idea_entry>*{position:relative;z-index:1}
...
with left:
    components.html(motion, height=328, scrolling=False)
with right:
