...
.st-key-bp_left_rail{{padding-top:12px!important}}.st-key-bp_left_rail .st-key-bp_home{{margin:0 0 36px!important}}.rail-top-progress{{margin:22px 6px 32px!important}}.st-key-bp_left_rail [data-testid="stExpanderDetails"] [data-testid="stButton"] button{{padding-left:0!important;justify-content:flex-start!important;text-align:left!important}}.st-key-bp_left_rail [data-testid="stExpanderDetails"] [data-testid="stButton"] button p{{width:100%!important;margin:0!important;text-align:left!important}}.kpi-label{{font-weight:600!important}}.st-key-bp_shortcut_blueprint,.st-key-bp_shortcut_financial{{position:relative;overflow:hidden;padding:14px!important;border-radius:15px!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.55)!important}}.st-key-bp_shortcut_blueprint{{background:radial-gradient(circle at 90% 10%,rgba(105,165,125,.16),transparent 45%),linear-gradient(145deg,#eef6f0,#e5f0e8)!important}}.st-key-bp_shortcut_financial{{background:radial-gradient(circle at 90% 10%,rgba(186,121,86,.13),transparent 45%),linear-gradient(145deg,#faf3ee,#f4e9e2)!important}}.st-key-bp_shortcut_blueprint:after,.st-key-bp_shortcut_financial:after{{content:'↗';position:absolute;right:14px;top:48px;color:#5f7867;font:600 13px var(--ui);pointer-events:none}}.st-key-bp_shortcut_financial:after{{color:#936b57}}.plan-native-head{{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:9px}}.plan-native-head small{{color:#718078;font:650 7px/1 var(--ui);letter-spacing:.055em;text-transform:uppercase}}.st-key-bp_shortcut_financial .plan-native-head small{{color:#8e7467}}.plan-native-icon{{display:grid;place-items:center;width:25px;height:25px;border-radius:8px;background:#d7e9dc;color:#286b45;font:650 12px var(--ui)}}.st-key-bp_shortcut_financial .plan-native-icon{{background:#eeddd3;color:#87563f}}.st-key-bp_shortcut_blueprint button,.st-key-bp_shortcut_financial button{{min-height:24px!important;padding-right:23px!important;font-size:13px!important;font-weight:650!important}}.st-key-bp_shortcut_blueprint [data-testid="stCaptionContainer"],.st-key-bp_shortcut_financial [data-testid="stCaptionContainer"]{{display:block!important;margin-top:5px!important;padding-right:12px!important;font-size:9px!important;line-height:1.4!important}}.st-key-bp_right_rail [data-testid="stExpander"] .st-key-bp_action_card_workspace{{padding:0!important;border:0!important;border-radius:0!important;background:transparent!important}}.action-count{{display:block;margin:3px 1px 0 auto;color:#858d87;font:600 9px var(--ui);text-align:right}}
...
def _render_plan_shortcuts() -> None:
    with st.container(key="bp_plan_shortcuts"):
        with st.container(key="bp_shortcut_blueprint"):
            st.markdown('<div class="plan-native-head"><span class="plan-native-icon">⌘</span><small>Connected system map</small></div>', unsafe_allow_html=True)
        ...
        with st.container(key="bp_shortcut_financial"):
            st.markdown('<div class="plan-native-head"><span class="plan-native-icon">$</span><small>Capital &amp; evidence</small></div>', unsafe_allow_html=True)
