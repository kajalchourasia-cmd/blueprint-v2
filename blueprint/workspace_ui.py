...
[data-testid="stAppViewContainer"],[data-testid="stHeader"]{{background:#fff}}[data-testid="stHeader"],[data-testid="stToolbar"],[data-testid="stSidebar"],[data-testid="stSidebarNav"],#MainMenu,footer{{display:none!important}}html,body,[data-testid="stAppViewContainer"],[data-testid="stAppViewContainer"]>.main,[data-testid="stMain"],[data-testid="stMainBlockContainer"]{{height:100vh!important;margin:0!important;padding:0!important;overflow:hidden!important}}main .block-container,[data-testid="stMainBlockContainer"]{{width:100%!important;max-width:none!important;padding:0!important}}main [data-testid="stHorizontalBlock"]:has(.st-key-bp_left_rail){{height:100vh!important;gap:0!important}}.st-key-bp_left_rail *,.st-key-bp_center_pane *,.st-key-bp_right_rail *{{font-family:var(--ui)!important}}[data-testid="stIconMaterial"],.material-symbols-rounded{{font-family:'Material Symbols Rounded'!important}}
...
.kpi-grid{{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin:22px 0 27px;background:transparent}}.kpi{{min-width:0;padding:14px 15px 13px;border:1px solid #dfe3df;border-radius:12px;background:#fff;box-shadow:none}}.kpi-label{{display:block;margin-bottom:7px;color:#687069;font:500 12px/1.2 var(--ui)}}.kpi-value-row{{display:flex;align-items:center;gap:7px;min-height:30px}}.kpi-value-row b{{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#172019;font:650 27px/1 var(--ui);letter-spacing:-.035em}}.kpi-badge{{display:inline-flex;align-items:center;gap:3px;flex:0 0 auto;padding:4px 7px;border-radius:9px;background:#e6f4ea;color:#287546;font:650 8px/1 var(--ui);text-transform:uppercase}}.kpi-badge:before{{content:'↗';font-size:8px}}.kpi-badge.watch{{background:#fff0e5;color:#a55228}}.kpi-badge.watch:before{{content:'!'}}.kpi-badge.neutral{{background:#f0f1f0;color:#707671}}.kpi-badge.neutral:before{{content:'·'}}.kpi-meta{{display:block;margin-top:7px;color:#8e958f;font:10px/1.3 var(--ui)}}
.st-key-bp_left_rail,.st-key-bp_center_pane,.st-key-bp_right_rail{{height:100vh;min-height:0;overflow-y:auto;overscroll-behavior:contain;scrollbar-gutter:stable}}.st-key-bp_left_rail{{border:0;border-right:1px solid #e2e4e2;border-radius:0;padding:12px 10px 28px!important;background:#f7f7f6}}.st-key-bp_center_pane{{border:0;border-radius:0;padding:20px 34px 120px!important;background:#fff}}.st-key-bp_right_rail{{height:calc(100vh - 12px);min-height:0;margin:6px 6px 6px 10px;padding:16px 14px!important;border:1px solid #e2e5e2;border-radius:16px;background:#fbfbfa;box-shadow:0 8px 24px rgba(25,36,28,.055)}}
...
.rail-summary{{padding:14px 12px 12px;border:1px solid #e2e5e2;border-radius:13px;background:#fff}}.rail-summary-head{{display:flex;justify-content:space-between;align-items:center;font:650 12px/1.2 var(--ui);color:#303833}}.rail-summary-head span:last-child{{font-size:10px;color:#7d847f}}.rail-progress{{height:5px;margin:12px 0 10px;border-radius:8px;background:#e5e7e5;overflow:hidden}}.rail-progress i{{display:block;height:100%;border-radius:8px;background:#1f2421;transition:width .35s ease}}.rail-stats{{display:grid;gap:7px}}.rail-stat{{display:flex;align-items:center;justify-content:space-between;color:#666e68;font:500 10px/1.2 var(--ui)}}.rail-stat span{{display:flex;align-items:center;gap:7px}}.rail-stat i{{width:12px;height:12px;border:1px solid #bfc5c0;border-radius:50%;background:#fff}}.rail-stat.live i{{border:3px solid #d8e9dc;border-top-color:#318052;animation:spin 1s linear infinite}}.rail-stat.done i{{border-color:#2f8051;background:#2f8051;box-shadow:inset 0 0 0 3px #fff}}.rail-stat b{{font-size:10px;color:#89908a}}.st-key-bp_left_rail [data-testid="stExpander"]{{margin-top:12px;border:0!important;border-radius:0!important;background:transparent!important}}.st-key-bp_left_rail [data-testid="stExpander"] details{{border:0!important;background:transparent!important}}.st-key-bp_left_rail [data-testid="stExpander"] summary{{min-height:34px!important;padding:0 7px!important;border-radius:8px!important;background:transparent!important;color:#687069!important;font:650 10px/1 var(--ui)!important;text-transform:uppercase}}.st-key-bp_left_rail [data-testid="stExpander"] details[open] summary{{border-bottom:1px solid #e0e4e0!important;border-radius:0!important;background:transparent!important;color:#424a44!important}}.st-key-bp_left_rail [data-testid="stExpanderDetails"]{{padding:4px 0 2px!important}}.st-key-bp_left_rail [data-testid="stButton"]{{width:100%!important;margin:2px 0!important}}.st-key-bp_left_rail [data-testid="stButton"] button{{position:relative;width:100%!important;min-width:0!important;min-height:36px!important;padding:7px 30px 7px 10px!important;border:0!important;border-radius:9px!important;background:transparent!important;color:#39423b!important;text-align:left!important;justify-content:flex-start!important;white-space:normal!important;font:500 12px/1.25 var(--ui)!important;box-shadow:none!important;transition:background .18s ease,transform .18s ease}}.st-key-bp_left_rail [data-testid="stButton"] button:hover{{transform:translateX(2px);background:#e9ece9!important}}
...
def _render_left_rail(states: dict[str, tuple[str, str]], selected: str, *, interactive: bool) -> None:
    ...
    st.markdown(
        ...
        f'<div class="rail-progress"><i style="width:{rail_percent}%"></i></div><div class="rail-stats">'
        f'<div class="rail-stat live"><span><i></i>Processing</span><b>{running_count}</b></div>'
