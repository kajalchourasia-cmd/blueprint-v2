...
def _render_plan_shortcuts() -> None:
    st.markdown(
        '<div class="plan-shortcuts">'
        '<a class="plan-shortcut" href="/Your_Plan?view=blueprint" target="_blank" rel="noopener"><i>⌘</i><b>Open Blueprint</b><small>Every stage, dependency, and unresolved decision.</small></a>'
